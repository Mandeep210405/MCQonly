...
//           <p style={{ fontSize: '12px', color: 'var(--text-muted)' }}>Time Remaining</p>
//           <p style={{ fontFamily: 'var(--font-display)', fontSize: '28px', fontWeight: '700', color: timeLeft?.minutes < 5 ? 'var(--status-terminated)' : 'var(--accent)' }}>
...
//                   <label key={key} style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px', borderRadius: '8px', border: '1px solid var(--border)', cursor: 'pointer' }}>
//                     <input
//                       type="radio"
...
//                     <p style={{ fontSize: '12px', color: 'var(--text-muted)', marginBottom: '4px' }}>Expected Output:</p>
//                     <pre style={{ fontSize: '13px', fontFamily: 'monospace', margin: 0 }}>{currentQ.expected_output}</pre>
//                   </div>
//                 )}
//                 <CodeMirror
